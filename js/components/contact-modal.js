document.addEventListener('DOMContentLoaded', function() {
    console.log('[contact-modal.js] Script loaded');
    ...
    console.log('[contact-modal.js] modal:', modal);
    console.log('[contact-modal.js] contactBtn:', contactBtn);
    console.log('[contact-modal.js] closeBtn:', closeBtn);
    console.log('[contact-modal.js] sendButton:', sendButton);
    console.log('[contact-modal.js] form:', form);

    // Open modal
    if (contactBtn) {
        contactBtn.addEventListener('click', function() {
            console.log('[contact-modal.js] contactMeBtn clicked!');
